...
class BannerPositionModel extends Model
{
    ...
    {
        try{
            $result =  $this->validate('BannerPositionValidate')->allowField(true)->save($param);
            if(false === $result){
    ...
    {
        try{
            $result =  $this->validate('BannerPositionValidate')->allowField(true)->save($param, ['id' => $param['id']]);
            if(false === $result){
