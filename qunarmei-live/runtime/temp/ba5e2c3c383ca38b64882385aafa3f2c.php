<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:109:"D:\software\phpstudy_pro\WWW\qunarmei-live\public/../application/admin\view\market_assessment\add_assess.html";i:1594783026;s:84:"D:\software\phpstudy_pro\WWW\qunarmei-live\application\admin\view\public\header.html";i:1587693029;s:84:"D:\software\phpstudy_pro\WWW\qunarmei-live\application\admin\view\public\footer.html";i:1574039645;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" name="edit" id="edit" method="post" action="<?php echo url('addAssess'); ?>?type=add">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">考核类型：</label>
                            <div class="col-sm-6">
                                <div class="radio i-checks">
                                    <input type="radio" name='assess_type' value="1" />直播&nbsp;&nbsp;
                                    <input type="radio" name='assess_type' value="2" />录像
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="assess_name" type="text" class="form-control" name="assess_name" placeholder="" value="">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                                <label class="col-sm-3 control-label">起止时间：</label>
                                <input type="text" id="begin_time" name="begin_time" required  lay-verify="required" placeholder="请输入开始时间" autocomplete="off" >至
                                <input type="text" id="end_time" name="end_time" required  lay-verify="required" placeholder="请输入结束时间" autocomplete="off" >
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select name="project_id"  lay-search="" id="project_id">
                                    ...
                                    <option value="<?php echo $v['id']; ?>"><?php echo $v['assess_project']; ?></option>
...
//        console.log(userdata2)
        $.ajax({
            url:"<?php echo url('getXzData'); ?>?type=add_assess",
...
//                $("#test_table").css("display","block");
    ...
    layui.use(['form','laydate','upload','table'], function() {
        ...
        form.on('submit(formDemo)', function (data){
            ...
            // 提交数据
            $.getJSON("<?php echo url('addAssess'); ?>?type=add",{tableData: tableData,formData: formData}, function(ret){
                num = ret.code;
                // 弹窗提示
