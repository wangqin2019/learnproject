...
(function (factory) {
    ...
    createDate = {
        ...
        resetActive:function(el,start,end){
             var d = new Date(),
            ...
            $('#date-wrapper ol').each(function() {
                ...
                e.children('li').each(function() {
                    ...
                    if (eId == 'd-year' && liText === start) {
                        li.addClass('active').siblings().removeClass('active');
                        return false;
                    } else if (eId == 'd-month' && liText === 1) {
                        li.addClass('active').siblings().removeClass('active');
                        return false;
                    } else if (eId == 'd-day' && liText === 1) {
                        li.addClass('active').siblings().removeClass('active');
                        return false;
    ...
    function DateTool(obj,start,end){
        var that = $(obj);
        that.bind('click',function() {
            ...
            if (!el.is(':visible')) {
                ...
                createDate.resetActive(that,start,end);
    ...
    $.date = function(obj,start,end){
        DateTool(obj,start,end);
