...
return [
	...
	'text' => [
		...
		'notice' => [
			...
			'content3' => '<p style="font-size:15;">感谢您信任并使用"去哪美"!<br/>我们非常注重您的个人信息和隐私保护,并依据最新的法律要求更新了<<隐私政策>>,特向您推送本提示。请您仔细阅读并充分理解相关条款,我们将严格按照您同意的条款使用您的个人信息,以便为您提供更好的服务。<br/><span style="color:gray;font-size:15;"> 如果您同意以上的政策及声明,请点击"同意"并开始使用我们的产品和服务。我们将尽全力保护您的个人信息及合法权益,再次感谢您的信任!</span></p>',
			'content4' => '感谢您信任并使用去哪美！\n\n您可使用本应用，进行商品浏览、支付购买等功能。我们将严格遵守相关法律法规和隐私政策以保护您的个人信息。请您阅读并同意<<账户使用协议>>、<<用户服务协议>>和<<隐私政策>>。',
			'content5' => '<p style="font-size:15;">感谢您信任并使用去哪美！<br/><br/>您可使用本应用，进行商品浏览、支付购买等功能。我们将严格遵守相关法律法规和隐私政策以保护您的个人信息。请您阅读并同意<<账户使用协议>>、<<用户服务协议>>和<<隐私政策>>。</p>',
		],
		// 能观看直播的门店编号白名单
		'store_live' => [
			'666-666',
	...
	'url' => [
		'qrcode_jump_url' => 'http://testc.qunarmei.com:9091/html/code/code.html',// 二维码扫码后跳转url
		'live_see_url' =>'http://live.qunarmei.com/index/index/login',//H5观看直播地址
  ...
  'limits' => 20 ,// 分页时每页条数
	...
	'card' => [
		...
		'zk_ws' => 'http://appc.qunarmei.com/zk_ws.png',// 展开无色规则
		'zk_ys' => 'http://appc.qunarmei.com/zk_ys.png',// 展开有色规则

		'card520_ws' => 'http://appc.qunarmei.com/card520_ws.png',// 520宠爱券展开无色规则
		'card520_ys' => 'http://appc.qunarmei.com/card520_ys.png',// 520宠爱券展开有色规则
	]
];