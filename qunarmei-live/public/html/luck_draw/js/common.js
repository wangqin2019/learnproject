// var url = 'https://pintest.qunarmei.com/api/h5/';
var url = 'https://pin.qunarmei.com/api/h5/';// 生产地址
//ajax异步
...
//ajax异步-php
function ajaxQunarPost(path,data){
	var res;
	$.ajax({
		type: 'post',
	    url: 'http://testc.qunarmei.com:9091/api/v4/cards/' + path,
		dataType: 'json',
		data: data,
		crossDomain: true,
	    async: false,
